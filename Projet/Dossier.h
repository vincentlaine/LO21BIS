...
class Dossier{
    ...
    Dossier(CursusManager* c, UVManager& u, Curs** tabCur, Inscription** tabI, Equivalence** tabE, bool aes, bool B2, unsigned int nc, unsigned int ni, unsigned int ne);
...
public :
    ...
    Curs** getCursus() const {return cursus;}
    ...
    void addCursus(Curs* c);

    void supprCur(Curs* c);
